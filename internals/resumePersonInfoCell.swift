...
fileprivate let preColleage:String = "学校:   "
...
@objcMembers class resumePersonInfoCell: UITableViewCell {
   ...
   dynamic var mode:personalBasicalInfo?{
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        _ = colleage.sd_layout().topSpaceToView(gender,10)?.leftEqualToView(gender)?.autoHeightRatio(0)
        _ = degree.sd_layout().topSpaceToView(colleage,10)?.leftEqualToView(colleage)?.autoHeightRatio(0)
