...
extension YNSearch{
    ...
    open func setShareSearchName(value: String){
        pref.setValue(value, forKey: "searchName")
    }
    open func getSearchName()->String?{
        guard let name = pref.object(forKey: "searchName") as? String else {return nil}
        return name
    }
}
